...
if ( ! function_exists('_parse_form_attributes'))
{
     ...
     * @return	string
     */
    function _parse_form_attributes(array $attributes, array $default)
    {
        if (is_array($attributes))
        {
...
if ( ! function_exists('word_limiter'))
{
     ...
     * @return string
     */
    function word_limiter(string $str, int $limit = 100, string $end_char = '&#8230;')
    {
        if (trim($str) === '')
        {
            return $str;
...
if ( ! function_exists('highlight_phrase'))
{
     ...
     * @return	string
     */
    function highlight_phrase(string $str, string $phrase, string $tag_open = '<mark>', string $tag_close = '</mark>')
    {
        return ($str !== '' && $phrase !== '')
...
if ( ! function_exists('word_wrap'))
{
     ...
     * @return	string
     */
    function word_wrap(string $str, int $charlim = 76)
    {
...
if ( ! function_exists('random_string'))
{
     ...
     * @return mixed
     */
    function random_string(string $type = 'alnum', $length = 8)
    {
        $random = '';
...
if ( ! function_exists('strposa'))
{
     ...
     * @return bool|mixed
     */
    function strposa($haystack, array $needles = array(), int $offset=0) {
        $chr = array();
