...
<form class="form-horizontal operator-group" action="{{ route('operator-group.save') }}" autocomplete="off" method="post" role="form" >
    @csrf
                    ...
                    @foreach($value->detail as $child)
                        <div class="module-list">
                            ...
                            <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <input name="update[]" type="checkbox" value="{{$child->modid}}" id="update-{{$child->modid}}" class="form-check-input">
                                ...
                                <div class="form-check form-check-inline">
                                    <input name="read[]" type="checkbox" value="{{$child->modid}}" id="read-{{$child->modid}}" class="form-check-input">
                ...
                @else
                    <div class="module-list">
                        ...
                        <div>
                            ...
                            <div class="form-check form-check-inline">
                                <input name="update[]" type="checkbox" value="{{$value->modid}}" id="update-{{$value->modid}}" class="form-check-input">
                            ...
                            <div class="form-check form-check-inline">
                                <input name="read[]" type="checkbox" value="{{$value->modid}}" id="read-{{$value->modid}}" class="form-check-input">
